...
final class CommunauteJeuController extends AbstractController
{
    ...
    {
        return $this->render('JeuCommunaute/communaute-jeu/index.html.twig');
    }
    ...
    public function premier_niveau(Request $request): Response
    {
        ...
        return $this->render('JeuCommunaute/communaute-jeu/premier_niveau.html.twig');
    }
    ...
    public function premiere_pierre_descendre(Request $request, InventaireService $inventaireService, SessionService $sessionService) : Response
    {
        ...
        return $this->render('JeuCommunaute/communaute-jeu/premier_niveau_premier_pierre_descendre.html.twig', []);
    }
