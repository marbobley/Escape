...
{
    public const TROLL_LLORT = 'llort';
    public const TROLL_L = 'l';
    public const TROLL_A = 'A';
        ...
        InventaireService $inventaireService): Response
    {
        ...
        return $this->render('JeuCommunaute/jardin/jardin.html.twig');
    }
    ...
    {
        return $this->render('JeuCommunaute/jardin/entree-jardin.html.twig', [
            'sortTete' => $sortTete,
            'sortMain' => $sortMain,
        ]);
    }
    ...
    public function jardin_secret(Request $request, SessionService $sessionService): Response
    {
        ...
        return $this->render('JeuCommunaute/jardin/entree-jardin-passage-secret.html.twig');
    }
        ...
        #[MapQueryParameter] int $alert = 0): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $pass = $data['pass'];
            $expectedResult = '';
            if ('mainConfusion' === $sortMain && 'teteConfusion' === $sortTete) {
                $sessionService->setTrollDead(self::TROLL_LLORT);
                $expectedResult = self::TROLL_LLORT;
            } elseif (
                ('mainConfusion' === $sortMain && 'teteAttraction' === $sortTete)
                || ('mainAttraction' === $sortMain && 'teteConfusion' === $sortTete)) {
        ...
        return $this->render('JeuCommunaute/jardin/lancer_sort_troll_jardin.html.twig', [
            'form' => $form,
            'sortTete' => $sortTete,
            'sortMain' => $sortMain,
            'alert' => $alert,
